...
def enviar_mensaje_telegram(mensaje: str) -> dict:
    """
    ...
    chat_id = obtener_credencial("telegram", "CHAT_ID")

    if not token or not chat_id:
        return {
            "success": False, 
            "message": "Faltan credenciales de Telegram (TOKEN o CHAT_ID) en secrets."
        }
